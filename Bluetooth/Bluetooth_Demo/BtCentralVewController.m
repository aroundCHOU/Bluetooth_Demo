...
#import "BtCentralVewController.h"

@interface BtCentralVewController ()
{
...
@implementation BtCentralVewController
...
//    NSString *pername=[NSString stringWithFormat:@"%@",peripheral.name];
    //判断是否存在@"你的设备名"
//    NSRange range=[pername rangeOfString:peripheral.name];
    //如果从搜索到的设备中找到指定设备名，和discoverPeripherals数组没有它的地址
    //加入discoverPeripherals数组
    if([discoverPeripherals containsObject:peripheral]==NO){
        [discoverPeripherals addObject:peripheral];
    }
...
-(void)centralManager:(CBCentralManager *)central didFailToConnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error
{
    ...
    self.statusLabel.text = [NSString stringWithFormat:@"与%@连接失败",[peripheral name]];
}

//Peripherals断开连接
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error{
    NSLog(@">>>外设连接断开连接 %@: %@\n", [peripheral name], [error localizedDescription]);
    self.statusLabel.text = [NSString stringWithFormat:@"与%@断开连接",[peripheral name]];
}
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral
{
    ...
    self.statusLabel.text = [NSString stringWithFormat:@"与%@连接成功",[peripheral name]];
    [central stopScan];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CBPeripheral *per=(CBPeripheral *)discoverPeripherals[indexPath.row];
...
{
    CBPeripheral *peripheral=(CBPeripheral *)discoverPeripherals[indexPath.row];
    //设定周边设备，指定代理者
